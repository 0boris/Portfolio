    ...
    <div class="grid grid-cols-5 grid-rows-3 gap-2">
      ...
      >
        ...
        <span class="text-xs opacity-80">
          I'm a passionate web developer with a love for creating clean designs.
        </span>
      </div>
      <div
      ...
      >
        ...
        <span class="text-xs opacity-80">
          I study Computer Science, Geography, Spanish, and Religious Studies. I
          like to attend extra-curricular clubs to extend my learning.
        </span>
      </div>
      <div
        transition:blur={{ duration: 300, delay: 800 }}
      ...
      >
        ...
        <span class="text-xs opacity-80">
          I want to hear from you. Tell me what you think about my website! <a
            class="font-semibold"
            href="/feedback">Complete the form here.</a
          >
        </span>
      </div>
      <div
        ...
        class="px-4 py-3 bg-white/10 rounded-lg flex flex-col text-sm col-span-1 row-span-1 justify-center"
      >
      <span class="font-bold text-sm">Your time</span>
